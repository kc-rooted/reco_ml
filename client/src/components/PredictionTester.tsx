...
export default function PredictionTester() {
  ...
  const handlePredict = async () => {
    ...
    try {
      const response = await axios.post('/api/predict', { userAnswers });
  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
      ...
      <div className="bg-[#222222] rounded-3xl p-8">
        <h2 className="text-2xl font-bold mb-6 text-white uppercase">Test Prediction</h2>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <select
              ...
              className="w-full bg-[#444444] rounded-xl pl-4 pr-12 py-3 text-white focus:outline-none focus:ring-2 focus:ring-primary-400/20"
            >
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-[#DAF612] hover:bg-[#c5e010] disabled:bg-gray-600 disabled:cursor-not-allowed text-gray-900 font-medium py-4 px-6 rounded-2xl transition-colors duration-200 flex items-center justify-center space-x-2 uppercase"
          >
            {loading ? (
              <>
      ...
      {predictions && (
        <div className="bg-[#222222] rounded-3xl p-8">
          <h2 className="text-2xl font-bold mb-6 text-white uppercase">Recommendations</h2>
          ...
          {predictions.chartData && (
            <div>
              <h3 className="text-lg font-semibold mb-4 text-white uppercase">All Shaft Probabilities</h3>
